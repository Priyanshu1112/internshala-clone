...
import AppliedJobStudent from "./AppliedJobStudent";
import AppliedInternshipStudent from "./AppliedInternshipStudent";
...
const StudentApplications = () => {
  ...
  return (
    <div className="bg-slate-200 rounded p-2 ">
      ...
      {isActive ? <AppliedInternshipStudent /> : <AppliedJobStudent />}
